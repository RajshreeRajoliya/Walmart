...
function hjkkkk() {
  ...
  function f1(p) {
    ...
    let v = searched_data.sort(function (a, b) {
      return parseFloat(Number(a.List_Price)) - parseFloat(Number(b.List_Price))
    })
    let ch = document.querySelector("#change")
    ch.innerText = ""
    ch.innerText = p
  ...
  function f2(p) {
    ...
    searched_data.sort(function (a, b) {
      return parseFloat(Number(b.List_Price)) - parseFloat(Number(a.List_Price))
    })
